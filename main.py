...
def start_teaching_ai_agent(episodes, no_of_players, epsilon, epsilon_decay_rate, lr, gamma):
    ...
    ai_player_1 = QLearningAgent(1, learning_rate=lr, gamma=gamma)
    # ai_player_1 = SarsaAgent(1, learning_rate=lr, gamma=gamma)
    ...
    for episode in range(0, episodes):
        ...
        ai_player_1.rewards.update_epsilon(new_epsilon_after_decay)
        ...
        max_expected_return_list.append(ai_player_1.rewards.max_expected_reward)
        ai_player_1.rewards.max_expected_reward = 0
...
win_rate_list, win_rate_ma, epsilon_list, max_expected_return_list, max_expected_return_list_ma = start_teaching_ai_agent(
    episodes, 1, epsilon, epsilon_decay_rate, learning_rate, gamma
)
